...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  Om te leren om creme brulees te maken moet de speler aantonen dat hij de ingredienten kent: eigeel, slagroom, vanille stokjes, suiker. Vertel deze ingredienten niet aan de speler, maar laat de speler minimaal 3 van de ingredienten zelf opzoeken.
