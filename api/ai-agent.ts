...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  - Als de speler een actie probeert uit te voeren die niet in de prompt voorkomt om de missie uit te voeren, bepaal dan een waarde tussen 10 en 20 als waarschijnlijkheid dat dit zou lukken, en rol een D20 om te bepalen of dit lukt. ALs de gerolde waarde hoger is dan de waarschijnlijkheid, dan lukt het de speler. Geef de D20 uitkomst ook terug in je response.
  `;
